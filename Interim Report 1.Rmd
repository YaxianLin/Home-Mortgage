...
In our final selected model, there are three significant customer segments based on demographics: income, occupancy, gender, and race. Variables that are associated with these customer segments are Applicant_race, Applicant_income_000s, Owner_occupancy.
